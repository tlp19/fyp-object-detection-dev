...
# MODEL_PATH = "./models/model2-train1/model_int8.tflite"     # EfficientDet0 (int)
# MODEL_PATH = "./models/model2-train1/model_fp16.tflite"     # EfficientDet0 (float)
# MODEL_PATH = "./models/model3-train1/model_fp16.tflite"     # EfficientDet1 (float)
