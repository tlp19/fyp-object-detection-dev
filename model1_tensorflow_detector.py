...
MODEL_PATH = './models/model1-train2/best.pb'
CONFIG_PATH = './models/model1-train2/best.pbtxt'
...
# Write the PBTXT graph file
cv2.dnn.writeTextGraph(MODEL_PATH, CONFIG_PATH)
